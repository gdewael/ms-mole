...
from ms_mole.models import FingerprintPredicterTransformer
...
def main():
    ...
    data_module = MsMoleMassSpecDataModule(
        ...
        n_peaks=128, prec_mz_intensity=1.1, matchms_kwargs={"mz_to": 1005}
    ),
    ...
    model = FingerprintPredicterTransformer(
        n_in=int(1005 / args.bin_width),  # number of bins
        layer_dims=[256] * args.n_layers,  # hidden layer sizes
